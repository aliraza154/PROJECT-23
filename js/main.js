...
$(document).ready(function () {
    ...
    let func = setInterval(function () {
        ...
        let days = Math.floor(remaningTime / (100000 * 60 * 60 * 24));
        let hours = Math.floor((remaningTime % (100000 * 60 * 60 * 24)) / (100000 * 60 * 60));
        let minutes = Math.floor((remaningTime % (100000 * 60 * 60)) / (100000 * 60));
        let seconds = Math.floor((remaningTime % (100000 * 60)) / 100000);
